...
const Info: React.FC = () => {
  return (
    <div className="  h-[410px] card px-[3px] flex flex-col mb-[12px] items-center md:w-[376px] md:items-center ">
      ...
      <div className="h-[380px] w-[367.5px] flex flex-row justify-between">
        ...
        <div className='flex flex-col '>
          ...
          <div className=" bg-[rgba(0,0,0,0.5)] w-[180px] h-[100px] px-[4px] py-[4px] flex flex-col mb-[4px]">
            <div className="w-[163px] h-[29px] flex items-center mx-[12px] my-[12px]">
          ...
          <div className=" bg-[rgba(0,0,0,0.5)] w-[180px] h-[97px] px-[4px] py-[4px] flex flex-col mb-[4px]"></div>
        </div>
      </div>
    </div>
  )
